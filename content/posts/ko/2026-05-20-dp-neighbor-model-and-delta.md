...
히스토그램에서도 같은 일이 벌어집니다. 한 사람을 다른 칸으로 옮기면 한 칸은 1 줄고, 다른 칸은 1 늘어납니다. 이런 이유로 교체 모델 상황에서는 L1 민감도가 2가 될 수 있습니다.[^dmns]
...
하지만 한 사람의 데이터가 통째로 공개됐는데 괜찮을 리가 없습니다. 그래서 δ는 **전체 인원의 역수보다 훨씬 작아야** 합니다. δ가 데이터 크기의 역수 수준이면 위험합니다.[^dwork]
