...
Amin 연구진도 이 점을 편향과 분산의 상충관계로 정리합니다. 한 사용자가 더 많이 기여할 수 있게 둘수록 보호에 더 많은 노이즈가 필요하고, 기여를 작게 제한하면 초과 데이터를 버리면서 편향이 생길 수 있습니다.[^6]
...
그런데 사용자는 이벤트 하나로 살지 않습니다. 하루 동안 여러 기능을 쓰고, 그 데이터가 반복해서 전송될 수 있습니다. Tang, Korolova 등의 분석은 macOS 10.12 구현에서 서버로 제출되는 데이터 한 건당 프라이버시 손실은 ε=1 또는 2였지만, 초기 네 기능을 합치면 하루 전체 손실이 최대 16까지 올라갈 수 있다고 보고했습니다.[^8]
